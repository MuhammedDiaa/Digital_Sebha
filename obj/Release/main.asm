...
; 2 exit points
;	.line	13; "main.c"	GPIO_Init_Port_pin(PORT_B,0,IN);
	MOVLW	0x01
	MOVWF	STK01
	MOVLW	0x00
	MOVWF	STK00
	...
	PAGESEL	$
;	.line	15; "main.c"	SSD_Init(SSD_L ,OFF,SSD_NULL);
	MOVLW	0x0a
	MOVWF	STK01
	MOVLW	0x00
	MOVWF	STK00
	...
	CALL	_SSD_Init
	PAGESEL	$
;	.line	16; "main.c"	SSD_Init(SSD_ML ,OFF,SSD_NULL);
	MOVLW	0x0a
	MOVWF	STK01
	MOVLW	0x00
	MOVWF	STK00
	...
	CALL	_SSD_Init
	PAGESEL	$
;	.line	17; "main.c"	SSD_Init(SSD_MR ,OFF,SSD_NULL);
	MOVLW	0x0a
	MOVWF	STK01
	MOVLW	0x00
	MOVWF	STK00
	...
	CALL	_SSD_Init
	PAGESEL	$
;	.line	18; "main.c"	SSD_Init(SSD_R,OFF,SSD_NULL);
	MOVLW	0x0a
	MOVWF	STK01
	MOVLW	0x00
	MOVWF	STK00
	...
	PAGESEL	$
_00106_DS_
;	.line	22; "main.c"	SSD_update();
	PAGESEL	_SSD_update
	CALL	_SSD_update
	PAGESEL	$
	GOTO	_00106_DS_
;	.line	24; "main.c"	return 0;
	RETURN	
; exit point of _main
